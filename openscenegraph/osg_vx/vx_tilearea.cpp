...
double CalcTilePixelArea(double screen_width,
                         double screen_height,
                         ...
                         std::vector<osg::Vec3d> const &list_ecef)
{
    ...
    std::vector<std::vector<osg::Vec2d>> list_tris(4);
    for(size_t i=0; i < list_tris.size(); i++) {
        list_tris[i].resize(3);
    }

    // Convert world space -> viewport space

    // left
    bool left_ok =
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[0],list_tris[0][0]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[1],list_tris[0][1]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[4],list_tris[0][2]);
    ...
    // bottom
    bool bottom_ok =
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[1],list_tris[1][0]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[2],list_tris[1][1]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[4],list_tris[1][2]);
    ...
    // right
    bool right_ok =
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[2],list_tris[2][0]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[3],list_tris[2][1]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[4],list_tris[2][2]);
    ...
    // top
    bool top_ok =
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[3],list_tris[3][0]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[0],list_tris[3][1]) &&
            ConvWorldToScreen(screen_width,screen_height,mvp,list_ecef[4],list_tris[3][2]);
